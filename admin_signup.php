...
<head>
    ...
    <title>Admin Signup Page - EmpowerHub</title>
...
<body>
            <div class="flex flex-col justify-center items-center p-8 glass">
                <h2 class="text-2xl font-bold text-gray-100 mb-4">Register New Admin</h2>
                <form class="w-full" method="POST" action="">
                    ...
                    <button type="submit" class=" text-white py-2 rounded mt-2 custom-button">Signup as Admin</button>
